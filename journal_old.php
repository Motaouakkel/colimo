            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Journal de consultation</li>
                    </ol>
                </div>
...
var ch =  1
      ...
      xhttp.open("POST", "acces_log.php", true);
	  
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xhttp.send("date1="+date_du+"&date2="+date_au);
