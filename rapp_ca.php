            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Historique écart C.A Agence/PDA</li>
                    </ol>
                </div>
...
function loadfile(f) {
	...
	function getJSONData() {
			...
			for (var i= 0; i < data.length; i++) {
					...
					data[i]['Ecart'] = Math.abs(data[i]['Mt facture'] - data[i]['Mt Brut']);
...
var pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
			 ...
			 {
                "uniqueName": "ecart",
                "formula": "(sum(\"Mt facture\") - sum(\"Mt Brut\"))",
                "caption": "Ecart",
                "format": "3dhvqfuq"
            },
			{
                "uniqueName": "ecart_abs",
                "formula": "sum(\"Ecart\")",
                "caption": "Ecart ABS",
                "format": "3dhvqfuq"
            }
    ...
    "options": {
        "grid": {
            "title": "Historique écart C.A Agence/PDA",
            "showHeaders": false,
