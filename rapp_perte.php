...
function  loadme(sup_id,ag_id) {
	...
	var ch =  1
		...
		xhr.send("description="+ document.getElementById("date1").value + ' -> ' + document.getElementById("date1").value + ' ,filtres : ' + text1 + ',' + text2 + "&action_name="+'Indicateurs de performance/Période');
		  ...
		  xhttp.open("POST", "acces11.php", true);
...
var pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
			 ...
			 {
                "uniqueName": "Mt Perte2",
                "formula": "(sum(\"Mt Perte2\")",
                "caption": "Perte Facturé",
                "format": "3dhvwiax"
            },
            
			 {
                "uniqueName": "ecart",
                "formula": "(sum(\"Mt Perte2\") - sum(\"Mt P.Comm\"))",
                "caption": "Ecart",
                "format": "3dhvqfuq"
            }
        ]
    ...
    "options": {
        "grid": {
            "title": "Rapprochement Perte Réel / Facturé",
            "showHeaders": false,
