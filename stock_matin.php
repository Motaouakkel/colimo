            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Stock Matin</li>
                    </ol>
                </div>
...
<?php include 'search.php' ?>								
								...
								<div class="col-md-6" >
												...
												<span class="radio-custom radio-primary mb5" >
                                                        <input type="radio" id="radioExample1" name="radioMeasure" value="1" checked="checked">
                                                        <label for="radioExample1" style="margin-top:6px !important;margin-left:5px !important">Qte</label>
                                                </span>
												
												<SPAN class="radio-custom mb5" >
                                                        <input type="radio" id="radioExample0" name="radioMeasure" value="0">
                                                        <label for="radioExample0" style="margin-top:6px !important;margin-left:5px !important">Kg</label>
                                                </span>
												
												<SPAN class="radio-custom mb5" >
                                                        <input type="radio" id="radioExample2" name="radioMeasure" value="2">
                                                        <label for="radioExample2" style="margin-top:6px !important;margin-left:5px !important">CA</label>
                                                </span>
...
function loadme(sup_id,ag_id , action) {
	...
	var ch =  1
		...
		xhttp.open("POST", "acces14.php", true);
...
function loadfile(f) {
	...
	function getJSONData() {
			...
			for (var i= 1; i < data.length; i++) {
				...
				data[i]['Kg'] = (data[i]['qty'] * data[i]['weight'] / 1000) ;
				data[i]['CA'] = (data[i]['qty'] * data[i]['price']);
