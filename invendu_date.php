...
function getJSONData() {
		 ...
		 data = $.parseJSON(f);
			...
			for (var i= 1; i < data.length; i++) {
				...
				if (data[i].Famille != "Lait Frais") {
					...
					data[i]['Mt Chargement H.L'] = data[i]['Mt Total Chargement'];
	...
	pivot1 = new WebDataRocks({
        ...
        "measures": [
			{
                "uniqueName": "Qt Chargement",
				"formula": "(sum(\"Qt Chargement\") +  sum(\"Qt Reliquat Invendu\"))",
                "caption": "Enlevement"
            },
            {
			...
			{
                "uniqueName": "Qt Vente_B",
                "agregation": "sum",
				"formula": "(sum(\"Qt Chargement\") +  sum(\"Qt Reliquat Invendu\") - sum(\"Qt Invendu\"))",
                "caption": "Vente"
            },
			{
                "uniqueName": "% Invendu",
