            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-link">
                            <a href="#">Journal de consultations</a>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="panel-menu p12 admin-form theme-primary">
                            <div class="row">
								...
								<div class="col-md-3">
                                      <a type="submit" href = "#" onclick="loadme('prospect_ws.php');" class="button btn-primary submit-btn">Consulter</a>
	...
	$('#example').DataTable( {
        ...
        "drawCallback": function ( settings ) {
            ...
            api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                        '<tr class="group" style="background-color:#4a89dc !important;color:white !important"><td colspan="7">'+group+'</td></tr>'
                    );
