                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            function loadme(sup_id, ag_id, action) {
                                ...
                                xhttp.open("POST", "acces10.php", true);
                                ...
                                var pivot1 = new WebDataRocks({
                                    ...
                                    report: {
                                        ...
                                        "slice": {
                                            ...
                                            "measures": [{
                                                    "uniqueName": "TX1",
                                                    "formula": "( sum(\"NB Factures 1\")  / sum(\"NB Clients 1\") ) * 100",
                                                    "caption": "Tx Facturation P1",
                                                    "format": "3dhvqfuq"
                                                },
                                                {
                                                    "uniqueName": "TX2",
                                                    "formula": "( sum(\"NB Factures 2\")  / sum(\"NB Clients 2\") ) * 100",
                                                    "caption": "Tx Facturation P2",
                                                    "format": "3dhvqfuq"
                                                }
                                            ]
                                        },
                                        "options": {
                                            "grid": {
                                                "title": "Evolution fact moy/secteur",
                                                "showHeaders": false,
