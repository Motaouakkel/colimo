            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Historique Perte/Secteur</li>
                    </ol>
                </div>
							   ...
							   <div class="row" style="margin-top:10px !important;">
								...
								<div class="col-md-6" >
												...
												<SPAN class="radio-custom mb5" >
                                                        ...
                                                        <label for="radioExample0" style="margin-top:6px !important;margin-left:5px !important">Valeur</label>
                                                </span>
												...
												<SPAN class="radio-custom mb5" >
                                                        ...
                                                        <label for="radioExample2" style="margin-top:6px !important;margin-left:5px !important">% Perte</label>
                                                </span>
...
function getJSONData() {
	...
	pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
                "uniqueName": "Mt P.Comm",
                "agregation": "sum",
                "caption": "Val Perte Com",
                "format": "3f5k9eku"
            }
        ],
        "expands": {
    ...
    "options": {
        "grid": {
            "title": "Historique Perte/secteur",
            "showHeaders": false,
...
<script>
   function setReport(m) {
	   ...
	   if (m == '1') {
		...
		if (m == '2') {
			 m1= [{
                "uniqueName": "% Perte Com",
                "formula": "(sum(\"Mt P.Comm\")  / sum(\"Mt Chargement\"))  * 100",
                "caption": "% Perte Com",
                "format": "intformat"
			}]
		}
