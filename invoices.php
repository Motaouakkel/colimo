            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Facturation/Période</li>
                    </ol>
                </div>
...
function getJSONData() {
	...
	var pivot1 = new WebDataRocks({
        ...
        "measures": [
			...
			{
				"uniqueName": "MoyCA",
				"formula": "sum(\"CA_BRUT\")  / max(\"NBJ\")",
				"caption": "Moy.CA",
				"format": "3dhvqfuq"
			},
			{
				"uniqueName": "MoyCAClt",
				"formula": "sum(\"CA\")  / max(\"NBJ\") / distinctcount(\"NumFacture\")",
				"caption": "Moy.CA / Facture",
				"format": "3dhvqfuq"
			},
            {
                "uniqueName": "NbFactures",
                "formula": "distinctcount(\"NumFacture\")",
                "caption": "Nb Factures"
            },
			{
				"uniqueName": "MoyFacture",
				"formula": "distinctcount(\"NumFacture\") / max(\"NBJ\")",
				"caption": "Moy.Nb Facture",
				"format": "3dhvqfuq"
			},
			{
                "uniqueName": "Remise",
			...
			{
				"uniqueName": "MoyRemise",
				"formula": "sum(\"Remise\")  / max(\"NBJ\")",
				"caption": "Moy.Remise",
				"format": "3dhvqfuq"
			},
			{
