...
return supid;
									...
									function getsec(){
										...
										var e = document.getElementById("f-sector");
var supid = e.options[e.selectedIndex].value;
...
sel.appendChild(opt); 
  ...
  loadagency("agency.php");
								 ...
								 <div class="col-md-2">
                                    <label class="field select">
                                        <select id="f-customer" name="f-customer"  onchange="loadsector(this.value)" >
<script>
...
<script>
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4) {
			var list = document.getElementById("f-sector");
...
while (list.hasChildNodes()) {   
  list.removeChild(list.firstChild);
	...
	var sel3 = document.getElementById('f-sector');
var opt3 = document.createElement('option');
opt3.appendChild( document.createTextNode("Tout") );
...
sel.appendChild(opt); 
      ...
      xhttp.open("POST", "secteur.php", true);
	  
    	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	  xhttp.send("sup_id="+partner);
      ...
      return;
								...
								<div class="col-md-2">
                                      <a type="submit" href = "#" onclick="loadme(getsec())" class="button btn-primary submit-btn">Consulter</a>
