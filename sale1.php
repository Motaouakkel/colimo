    ...
    <!-- End: Theme Preview Pane -->
        ...
        <header class="navbar navbar-fixed-top bg-light">
            <div class="navbar-branding">
                <a class="navbar-brand" href="#"> <b>SILDA</b>REPORTING
                </a>
                    ...
                    <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                        ...
                        <li class="br-t of-h">
                            <a href="#" class="fw600 p12 animated animated-short fadeInDown">
                                <span class="fa fa-gear pr5"></span> Paramétrage</a>
                        </li>
                        <li class="br-t of-h">
            ...
            <header id="topbar" class="wdr-ui-element">
             ...
             <div class="topbar-right">
					   ...
					   <div class="col-md-6">
														    ...
														    <a type="submit" href = "#" onclick="loadme('acces1.php');" class="button btn-primary submit-btn">Consulter</a>
...
var pivot1 = new WebDataRocks({
        ...
        "measures": [
            ...
            {
                "uniqueName": "% Invendu",
                "formula": "(sum(\"Mt Invendu\")  / sum(\"Mt Chargement\"))  * 100",
                "caption": "% Invendu",
                "format": "3dhvqfuq"
            },
            {
