            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Evolution indicateurs Performance/Produit</li>
                    </ol>
                </div>
...
document.getElementById("date4").value = c;
 ...
 function loadme(sup_id,ag_id , action ) {
	...
	var DDU2 = document.getElementById("date3").value ;
	DDU2 = DDU2.split('/');
	//var date_du1 = DDU2[2]+""+DDU2[1]+""+DDU2[0] ;
	

	var DAU2 = document.getElementById("date4").value ;
	DAU2 = DAU2.split('/');
	//var date_au1 = DAU[2]+""+DAU[1]+""+DAU[0] ;
	
	var date1 = new Date(DDU[2],DDU[1],DDU[0]);
	var date2 = new Date(DAU[2],DAU[1],DAU[0]);
	var date3 = new Date(DDU2[2],DDU2[1],DDU2[0]);
	var date4 = new Date(DAU2[2],DAU2[1],DAU2[0]);
...
var pivot1 = new WebDataRocks({
    ...
    "options": {
        "grid": {
            "title": "Evolution indicateurs Performance/Produit",
            "showHeaders": false,
