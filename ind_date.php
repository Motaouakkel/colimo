            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Historique des Indicateurs de performance</li>
                    </ol>
                </div>
...
var pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
			 ...
			 {
                "uniqueName": "R.Lait",
                "formula": "(sum(\"CA Lait\")  / sum(\"Mt Brut\"))  * 100",
                "caption": "Ratio Lait",
                "format": "3dhvwiax"
            },
            {
			...
			,{
                "uniqueName": "qs",
                "formula": "(sum(\"Mt Commande\")  / sum(\"Mt Chargement\"))  * 100",
                "caption": "Q.S",
                "format": "3dhvwiax"
            }
        ]
    ...
    "options": {
        "grid": {
            "title": "Historique des Indicateurs de performance",
            "showHeaders": false,
