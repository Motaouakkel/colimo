            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Historique invendus</li>
                    </ol>
                </div>
							   ...
							   <div class="row" style="margin-top:10px !important;">
								...
								<div class="col-md-6" >
												...
												<SPAN class="radio-custom mb5" >
                                                        ...
                                                        <label for="radioExample2" style="margin-top:6px !important;margin-left:5px !important">% Invendu</label>
                                                </span>
...
function getJSONData() {
	...
	pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
                "uniqueName": "Mt Invendu H.L",
                "agregation": "sum",
                "caption": "Val Invendu H.L",
                "format": "3f5k9eku"
            }
        ],
        "expands": {
   ...
   function setReport(m) {
	   ...
	   if (m == '1') {
		...
		if (m == '2') {
			 m1= [{
                "uniqueName": "% Invendu",
                "formula": "(sum(\"Mt Invendu H.L\")  / sum(\"Mt Chargement H.L\"))  * 100",
                "caption": "% Invendu H.L",
                "format": "intformat"
			}]
		}
