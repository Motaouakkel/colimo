            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-link">
                            <a href="#">Les clients non visités</a>
                        </li>
                    </ol>
                </div>
	...
	$('#example').DataTable( {
        ...
        "drawCallback": function ( settings ) {
            ...
            api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                        '<tr class="group" style="background-color:#4a89dc !important;color:white !important"><td colspan="10">'+group+'</td></tr>'
                    );
      ...
      xhttp.open("POST", "nonvisited_ws.php", true);
	  
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	  xhttp.send("date1="+date_du+"&date2="+date_au+"&partner_id="+sup);
