                    ...
                    <div class="row">
                        ...
                        <div class="panel-menu p12 admin-form theme-primary">
                            <div class="row">
								...
								<div class="col-md-3">
                                      <a type="submit" href = "#" onclick="loadme('affectation_ws.php');" class="button btn-primary submit-btn">Consulter</a>
	...
	$('#example').DataTable( {
        ...
        "drawCallback": function ( settings ) {
            ...
            api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                        '<tr class="group" style="background-color:#4a89dc !important;color:white !important"><td colspan="5">'+group+'</td></tr>'
                    );
