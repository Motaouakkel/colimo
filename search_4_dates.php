<script>
    ...
    function loadme(sup_id, ag_id, action) {
        ...
        DAU = DAU.split('/');
        var date1 = DAU[2] + "" + DAU[1] + "" + DAU[0];

        var DAU = document.getElementById("date2").value;
        DAU = DAU.split('/');
        var date2 = DAU[2] + "" + DAU[1] + "" + DAU[0];

        var DAU = document.getElementById("date3").value;
        DAU = DAU.split('/');
        var date3 = DAU[2] + "" + DAU[1] + "" + DAU[0];


        var DAU = document.getElementById("date4").value;
        DAU = DAU.split('/');
        var date4 = DAU[2] + "" + DAU[1] + "" + DAU[0];

        var ch = 1

        var str = "?date1=" + date1 + "&date2=" + date2 + "&date3=" + date3 + "&date4=" + date4;
        ...
        xhttp.send("action=" + action + "&date1=" + date1 + "&date2=" + date2 + "&date3=" + date3 + "&date4=" + date4 + "&user_id=" + sup_id + "&agency_id=" + ag_id);
            ...
            <select id="filter-customer" name="filter-customer" onchange="loadpartner(this.value)">
                <script>
                    ...
                    function loadagency(link) {
                        ...
                        var str = "?date1=" + date1 + "&date2=" + date_au;
                        ...
                        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                        xhttp.send("date1=" + date1 + "&date2=" + date1 + "&ch=" + ch);
