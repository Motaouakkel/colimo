			...
			for (var i= 1; i < data.length; i++) {
				if (i>1) {
					if (data[i].Secteur == data[i-1].Secteur) {
						data[i].Intra = (data[i].Sec_Scan - data[i-1].Sec_Time + 3600);
						data[i].Duree = (data[i].Duree - 3600);
						data[i].Sec_Scan = (data[i].Sec_Scan + 3600);
					}
				}
			}
			//console.log(data);
				...
				"slice": {
					...
					"expands": {
						...
						"rows": [
							{
								"tuple": [
									"Secteur.AIT MELLOUL L3ZIB"
								]
							},
							{
								"tuple": [
									"Secteur.AIT MELLOUL LMASSIRA"
								]
							},
							{
								"tuple": [
									"Secteur.KASBAT TAHER"
								]
							},
							{
								"tuple": [
