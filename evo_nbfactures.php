                        ...
                        <div class="panel-menu p12 admin-form theme-primary">
                            <div class="row" style="margin-bottom:10px !important">
							  ...
							  <div class="row">
								...
								<div class="col-md-4">
                                      <a type="submit" href = "#" onclick="loadme('acces10.php');" class="button btn-primary submit-btn">Consulter</a>
...
function loadme(link) {
	...
	nb_jours1 = (Math.ceil(timeDiff / (1000 * 3600 * 24)));
	...
	nb_jours2 = (Math.ceil(timeDiff / (1000 * 3600 * 24)));
...
var pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
                "uniqueName": "NB Factures 1",
				"caption": "NB Factures Moy P1",
                "aggregation": "sum",
                "format": "3dhvwiax"
            },
			{
                "uniqueName": "NB Factures 2",
				"caption": "NB Factures Moy P2",
                "aggregation": "sum",
                "format": "3dhvwiax"
            },
			{
                "uniqueName": "Evo",
                "formula": "( sum(\"Diff\")  / sum(\"NB Factures 1\") ) * 100",
                "caption": "Evo NB Fact",
                "format": "3dhvqfuq"
            }		
        ]
