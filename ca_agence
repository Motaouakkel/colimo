            ...
            <header id="topbar" class="wdr-ui-element">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-link">
                            <a href="#">HISTORIQUE VENTES PAR AGENCES</a>
                        </li>
                    </ol>
                </div>
             <div class="topbar-right">
			 <span class="label label-rounded label-default">A</span><span class="label label-default">Vitrine Type 1</span>
				<span class="label label-rounded label-primary">B</span><span class="label label-primary">Vitrine Type 2</span>
				<span class="label label-rounded label-success">C</span><span class="label label-success">Vitrine Type 3</span>
...
function getJSONData() {
	...
	pivot1 = new WebDataRocks({
        ...
        "measures": [
            {
                "uniqueName": "Mt vente",
                "formula": "sum(\"Prix\")  * (sum(\"Vente\") - sum(\"Perte\"))",
                "individual": true,
                "caption": "Mt vente",
				"format": "3dhvqfuq"
            }
    ...
    "options": {
        "grid": {
            "title": "HISTORIQUE VENTES PAR AGENCES",
            "showHeaders": false,
            "showGrandTotals": "on",
